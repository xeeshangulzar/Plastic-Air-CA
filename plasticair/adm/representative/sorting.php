...
$countryCode=(empty($_REQUEST["countryCode"]))?"CA":$_REQUEST["countryCode"];
...
$sSQLwhere=" AND countryCode='$countryCode'";
...
<td width="10"></td>
<td><A class="listingHeaderLinks">Title</a></td>
<td><A class="listingHeaderLinks">Category</a></td>
...
<td style="padding:3px;"><?=$arr_countryCodes[$row['countryCode']]?></td></tr><?
