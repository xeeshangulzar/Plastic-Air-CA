...
{
	$sSQLwhere.=" AND ( email LIKE '%".$keyWord."%' OR fname LIKE '%".$keyWord."%' OR lname LIKE '%".$keyWord."%')";	
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="listingTitles">
                          ...
                          <td><A href="#" onClick="javascript: sort_list('fname,lname'); return false;" class="listingHeaderLinks">Name</a></td>
                          <td><A href="#" onClick="javascript: sort_list('active'); return false;" class="listingHeaderLinks">Active</a></td>
                          <td><A href="#" onClick="javascript: sort_list('confirmed'); return false;" class="listingHeaderLinks">Confirmed</a></td>
                        </tr>
						<?
						$result=mysql_query($sSQL) or die ("MySQL err: ".mysql_error()."<br>".$sSQL);
						$bgColor="FFFFFF";
                        ...
                        <tr onMouseOver='javascript: act_row(this);' onmouseout="javascript: inact_row(this,'<?=$bgColor?>')"  onClick="window.location='/adm/<?=$folderName?>/addEdit.php?<?=$tableID?>=<?=$row[$tableID]?>'; return false;" class="arial12_black" bgcolor="<?=$bgColor?>">
                          ...
                          <td style="padding:3px;"><?=$row['fname']." ".$row['lname']?></td>
                          <td style="padding:3px;"><img src="/adm/img/chk<?=(!empty($row['active']))?"Yes":"No"?>.gif"  /></td>
                          <td style="padding:3px;"><img src="/adm/img/chk<?=(!empty($row['confirmed']))?"Yes":"No"?>.gif"  /></td>
                        </tr><?
