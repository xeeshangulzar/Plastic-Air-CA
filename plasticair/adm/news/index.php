...
<td><A href="#" onClick="javascript: sort_list('newsDate'); return false;" class="listingHeaderLinks">News Date</a></td>
<td><A href="#" onClick="javascript: sort_list('headline '); return false;" class="listingHeaderLinks">Headline </a></td></tr><?
$result=mysql_query($sSQL) or die ("MySQL err: ".mysql_error()."<br>".$sSQL);
$bgColor="FFFFFF";
while($row=mysql_fetch_array($result)) {
		...
		<td style="padding:3px;"><?=$row['newsDate']?></td>
		<td style="padding:3px;"><?=$row['headline']?></td></tr><?
