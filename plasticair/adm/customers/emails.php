...
<td width="1" background="/adm/img/tabs_bg_right.jpg"></td>
<td background="/adm/img/tabs_active_bg.jpg"><a href="/adm/<?=$folderName?>/emails.php" class="tabLink"><b>Emails</b></a></td>
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="listingTitles">
                          ...
                          <td width="10"></td>
                          <td><A href="#" onClick="sort_list('email'); return false;" class="listingHeaderLinks">Email</a></td>
                        </tr><?
$result=mysql_query($sSQL) or die ("MySQL err: ".mysql_error()."<br>".$sSQL);
$bgColor="FFFFFF";
while($row=mysql_fetch_array($result)) {
		...
		<td style="padding:3px;"><?=$row['email']?></td></tr><?
