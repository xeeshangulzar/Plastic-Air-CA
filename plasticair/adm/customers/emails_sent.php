...
$tableName="news_letters_sent";
$tableID="news_letters_sentID";
...
?><form name='ff1' class='form' method='POST' action='' enctype="multipart/form-data" ><table border="0" cellspacing="0" cellpadding="0" class="text" width="100%">
...
<td background="/adm/img/tabs_bg.jpg"><a href="/adm/<?=$folderName?>/newsLetter.php" class="tabLink">Newsletter</a></td>
<td width="1" background="/adm/img/tabs_bg_right.jpg"></td>
...
<td background="/adm/img/tabs_active_bg.jpg"><a href="/adm/<?=$folderName?>/emails_sent.php" class="tabLink"><b>Emails Sent</b></a></td>
<td width="1" background="/adm/img/tabs_bg_right.jpg"></td>
<td width="1"></td></tr>
</table></td>
...
{
	$sSQLwhere.=" AND ( ".$tableName.".title LIKE '%".$keyWord."%')";	
...
<td width="10"></td>
<td><A href="#" onClick="sort_list('recipients'); return false;" class="listingHeaderLinks">Recipients</a></td>
<td><A href="#" onClick="sort_list('created'); return false;" class="listingHeaderLinks">Created</a></td>
<td><A href="#" onClick="sort_list('subject'); return false;" class="listingHeaderLinks">Subject</a></td>
<td><A href="#" onClick="sort_list('body'); return false;" class="listingHeaderLinks">Body</a></td>
<td><A href="#" onClick="sort_list('lettersSent'); return false;" class="listingHeaderLinks">LettersSent</a></td>
</tr><?
$result=mysql_query($sSQL) or die ("MySQL err: ".mysql_error()."<br>".$sSQL);
$bgColor="FFFFFF";
while($row=mysql_fetch_array($result)) {
		...
		<td style="padding:3px;"><?=$row['recipients']?></td>
		<td style="padding:3px;"><?=$row['created']?></td>
		<td style="padding:3px;"><?=$row['subject']?></td>
		<td style="padding:3px;"><?=strip_tags($row['body'])?></td>
		<td style="padding:3px;"><?=$row['lettersSent']?></td></tr><?
