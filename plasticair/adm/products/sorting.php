...
$arr_parents=array(); $arr_category=array();
while($row1=mysql_fetch_array($result1)){
	$product_categoryID=empty($product_categoryID)?$row1['product_categoryID']:$product_categoryID;
	$arr_parents[$row1['parentID']][$row1['product_categoryID']]=$row1['title'];
		$arr_category[$row1['product_categoryID']]=$row1['title'];}
...
<td><select name="product_categoryID" id="product_categoryID" class="inputField" style="width:200px;"><?
...
<td style="padding:3px;"><?=$arr_category[$row['product_categoryID']]?></td></tr><?
