   ...
   function writeScatterLabel($ScatterSerieID,$Points,$Format="")
    {
     ...
     $DrawPoint		= isset($Format["DrawPoint"]) ? $Format["DrawPoint"] : LABEL_POINT_CIRCLE;
     $Decimals		= isset($Format["Decimals"]) ? $Format["Decimals"] : NULL;
     $DrawLabelBox      = isset($Format["DrawLabelBox"]) ? $Format["DrawLabelBox"] : TRUE;
