...
$MyData->setaxisName(1,"Static Pressure");
$MyData->setaxisXY(1,AXIS_Y);
$MyData->setAxisPosition(1,AXIS_POSITION_LEFT );

$MyData->addPoints($hp,"HP");
$MyData->setSerieOnAxis("HP",2);
$MyData->setaxisName(2,"Horse Power");
...
$myPicture->setGraphArea(90,80,700,600);
$myPicture->setFontProperties(array("FontName" =>"../fonts/GeosansLight.ttf"));
$myPicture->drawFilledRectangle(90,80,699,599,array("R"=>200,"G"=>200,"B"=>200,"Surrounding"=>-200,"Alpha"=>100));
$myPicture->drawGradientArea(0,0,700,700,DIRECTION_VERTICAL,array("StartR"=>220,"StartG"=>220,"StartB"=>220,"EndR"=>255,"EndG"=>255,"EndB"=>255,"Alpha"=>100));


$AxisBoundaries = array(
    0=>array("Min"=>0,"Max"=>$MyData->getMax("Volume Flow")),
    1=>array("Min"=>0,"Max"=>$MyData->getMax("StaticPressure")),
    2=>array("Min"=>0,"Max"=>$MyData->getMax("HP")),
    5=>array("Min"=>0,"Max"=>$MyData->getMax("StaticPressure")),
...
$myPicture->drawText(110,35,"Fan Curve",array("FontSize"=>30,"Align"=>TEXT_ALIGN_BOTTOM ) );
$myPicture->drawText(600,700,"System Curve",array("R"=>229,"G"=>203,"B"=>136));
$myPicture->drawFilledRectangle(580,685,595,700,array("R"=>229,"G"=>203,"B"=>136,"Surrounding"=>-200,"Alpha"=>100));
$myPicture->drawText(600,720,"BHP",array("R"=>212,"G"=>85,"B"=>255));
$myPicture->drawFilledRectangle(580,730,595,740,array("R"=>117,"G"=>182,"B"=>227,"Surrounding"=>-200,"Alpha"=>100));
$myPicture->drawText(600,740,"SP",array("R"=>117,"G"=>182,"B"=>227));
$myPicture->drawFilledRectangle(580,710,595,725,array("R"=>212,"G"=>85,"B"=>255,"Surrounding"=>-200,"Alpha"=>100));
