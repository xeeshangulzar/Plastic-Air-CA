...
if(!empty($_POST["formSubmit"]) && $_POST["formSubmit"]=="submited")
{
	if(!empty($_POST["secretNumber"]) && $_SESSION["secureNumber"]==md5($_POST["secretNumber"])){
		if($_POST["formSubmit"]=="submited")
		{
			...
			//$mailbody.="<tr><td><b>Address:</b> </td><td> ".stripslashes($_POST['Address'])."</td></tr>";
...
<tr><td width="25"></td>
<td align="left" valign="top" class="arial_17_white_italic_bold">Contact Us</td></tr>
<tr><td colspan="2" height="40"></td></tr>
<tr><td width="25"></td>
<td align="left"><a href="#" class="subnav_link">Home</a><span class="subnav_divider">/</span><a href="#" class="subnav_link_active">Contact Us</a></td></tr>
<tr><td>&nbsp;</td>
<td>&nbsp;</td></tr>
</table></td>
...
<tr><td width="665" align="left"><?=empty($mess)?'':$mess?><table width="600" border="0" cellspacing="0" cellpadding="0" align="left">
<tr><td colspan="3" class="arial_13_green_bold"><?=$description?></td></tr>
<tr><td colspan="3" style="padding-top:2px; padding-bottom:7px;" ></td></tr>
...
<tr><td align="right"><img src="/img/btn-submit.jpg" hspace="0" vspace="0" border="0" alt="" onclick="return chkFields();" style="cursor:pointer;"></td></tr>
...
<tr><td> <div style="border:#666666 solid 1px;"><iframe width="300" height="325" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.ca/maps?f=q&source=s_q&hl=&geocode=&q=<?= $address_map ?>&aq=0&sll=&sspn=&ie=UTF8&iwloc=near&hq=&hnear=<?= $address_map ?>&z=15&ll=&output=embed"></iframe><br /><small><a href="http://maps.google.ca/maps?f=q&source=embed&hl=en&geocode=&q=<?= $address_map ?>&aq=0&sll=&sspn=&ie=UTF8&hq=&hnear=<?= $address_map ?>&z=14&ll=" style="color:#0000FF;text-align:left" target="_blank">Print</a></small></div></td></tr></table></td></tr>
